...
void broadcastWS() {
  ...
  nodeJson[F("Temperature")]    = (float) sensorData.temperature / 100;
  nodeJson[F("Humidity")]       = (float) sensorData.humidity / 100;
  nodeJson[F("Pressure")]       = (float) sensorData.pressure / 100;
  nodeJson[F("LightSensor")]    = sensorData.lightSensor;
